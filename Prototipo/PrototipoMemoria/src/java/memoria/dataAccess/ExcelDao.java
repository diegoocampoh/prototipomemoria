    ...
    public List<SpatialDTO> getData(List<QueryParams> parametros) {
        try {
            ...
            for(int i = 1; i <503; i++){
                ...
                toReturn.addGeoReferencedObject(escuela);
            }
            List<SpatialDTO> result = new ArrayList<SpatialDTO>();
            result.add(toReturn);
            return result;
